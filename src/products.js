const overshirt = {
  ...
  heroImage: '/assets/overshirt-hero.png',
...
export const products = [
  ...
  },
  {
    ...
    heroImage: '/assets/hoodie-hero.png',
  ...
  },
  {
    ...
    heroImage: '/assets/cargo-hero.png',
...
export function artwork(product, extraClass = '', loading = 'lazy', hero = false) {
  return `<span class="product-art ${product.className} ${extraClass} ${hero ? 'hero-front' : ''}"><img src="${hero ? product.heroImage : product.sheet}" data-single="${hero}" alt="${product.name}, ${product.color}, front view" loading="${loading}" ${hero ? 'fetchpriority="high"' : ''} draggable="false" /></span>`;
}
